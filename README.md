...
## 1. 주 5회 이상 하루에 한 번 이상 PR 하기
  - 공용 repo 에서 작업 브랜치를 따서, 오늘 공부한 내용을 기록합니다.
  - 강의 내용 필기, 강의 내용에서 중요하게 보아야 하는 개념 추가적으로 공부, github 등... 벡엔드 분야라면, 범위는 상관없습니다. 자유롭게 commit & PR 해주세요. 매일 꾸준히 공부하는 것이 중요합니다.
  - 모임장은 팀원들이 올려준 PR 을 merge 한 후,단톡방에 공지한다. 팀원들이 올려준 PR 들의 merge를 미루다가, conflict가 날 수 있으므로, 부지런히 그 날의 PR들을 확인 후, merge 하도록 합니다.
  - 매일 공부하기 힘들다면, 게더타운에서 모여, 다르 팀원들이 공부하는 모습을 보며, 자극 받아보세요! 매일 매일 꾸준히 하는 것 보다 더 좋은 공부 방법은 없습니다.
링크 : https://app.gather.town/app/6hRjBlI3X4KppsK4/WorkStudyCafe
비밀번호 : 1234
...
## 2. 매주 화요일 오후 9시 미팅에 참석한다.
  - 그 주에 공부한 내용들을 돌아가며 발표합니다.
    ...
    - 내가 아는 것이 있으면, 팀원들과 지식을 공유하며, 더욱 더 내 것으로 정리해나갑니다.
    - 미팅은 구글 밋으로 진행합니다. 모임장은 스터디가 시작하기 최소 10분 전에 카카오톡 방에 구글 밋 링크를 공유합니다.
